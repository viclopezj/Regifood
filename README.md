...
Puede validar la correcta conexión, la salud de las instancias de la JVM y el mapeo automático de puertos dinámicos ingresando al panel de control interactivo. Dashboard de Eureka: http://localhost:8761
...
4. Servicio de Gerentes (/api/v1/gerentes)
     Métodos CRUD:
...
5. Servicio de Proveedores (/api/v1/proveedores)
     Métodos CRUD:
     ...
     GET /api/v1/proveedores/region/{region} - Filtra proveedores buscando por coincidencia de la region.

6. Servicio de Inventarios (/api/v1/inventarios)
     Métodos CRUD:
...
7. Servicio de Menús (/api/v1/menus)

     Métodos CRUD Tradicionales:
...
8. Servicio de Categorías (/api/v1/categorias)
...
10. Servicio de Marcas (/api/v1/marcas)
